...
@ConditionalOnProperty(name = "twitter-to-kafka-service.enable-mock-tweets", havingValue = "true")//this annotation creates a spring bean with a configuration variable.
																		// if enable-mock-tweets not found in config the original implementation, this variable created will be loaded and used
